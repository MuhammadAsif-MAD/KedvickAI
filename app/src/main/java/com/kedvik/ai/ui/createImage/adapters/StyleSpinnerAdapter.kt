...
class StyleSpinnerAdapter(context: Context, private var flags: IntArray, private var countryNames: Array<String>) : BaseAdapter() {
    ...
    override fun getView(i: Int, convertView: View?, viewGroup: ViewGroup): View {
        val view = inflater.inflate(R.layout.item_custom_spinner, null)
    ...
    override fun getDropDownView(i: Int, convertView: View?, parent: ViewGroup): View {
        val view = inflater.inflate(R.layout.item_custom_spinner, parent, false)
        val icon = view.findViewById<ImageView>(R.id.imageView)
        val names = view.findViewById<TextView>(R.id.textView)
        icon.setImageResource(flags[i])
        names.text = countryNames[i]
