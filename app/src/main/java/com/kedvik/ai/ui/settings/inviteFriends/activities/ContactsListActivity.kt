...
import com.kedvik.ai.ui.settings.inviteFriends.adapters.ContactsAdapter
import com.kedvik.ai.ui.settings.inviteFriends.model.ContactsModel
import com.kedvik.ai.R
import com.kedvik.ai.databinding.ActivityContactsListBinding
...
open class ContactsListActivity : BaseActivity(), LoaderManager.LoaderCallbacks<Cursor>, ContactsAdapter.InviteFriendContactAdapterCallBacks {
    ...
    override fun onInviteFriendContact(contactsModel: ContactsModel) {
        val smsBody = "Introducing kedvik: the ultimate mobile app for research, content creation, text-to-speech transcription, and image generation. Perfect for students, bloggers, and professionals. Download the app now and use this referral code: $referralCode\n" +
                "\n" +
                "App link: https://apps.kedvik.com\n"
