...
object SessionAndCookies {
    private const val SESSION_AND_COOKIES = "KEDVICKAISessionAndCookies"
    private const val PRIVACY_SESSION_AND_COOKIES = "KEDVICKAIPrivacySessionAndCookies"
    ...
    fun savePopupBoolean(context: Context, key: String?, value: Boolean) {
        val sharedPref = context.getSharedPreferences("kedvickPopopSessionAndCookies", Context.MODE_PRIVATE)
        val editor = sharedPref.edit()
        editor.putBoolean(key, value)
        editor.apply()
    }
